...
const string strMessageMagic = "thomasJefferson Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
  ...
  else if(pindexBest->nHeight < 1850101)
  {
      nSubsidy = 700 * COIN;
  }
  else if(pindexBest->nHeight < 5550101)
  {
      nSubsidy = 350 * COIN;
  }
  else if(pindexBest->nHeight < 12950101)
  {
      nSubsidy = 175 * COIN;
  }
...
// thomasJefferson: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "thomasJefferson", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Jefferson";
        CTransaction txNew;
        txNew.nTime = 1490980984;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x0974236908893fce4b4602b70330ca39f3749c16b2290f7a80f8dc9a0727ab1a"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf1, 0x2a, 0xa2, 0x72 };
