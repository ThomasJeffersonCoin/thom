...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("thomasJefferson-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("thomasJefferson-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("thomasJefferson-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "thomasJefferson " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("thomasJefferson-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("thomasJefferson-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("thomasJefferson-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("thomasJefferson-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. thomasJefferson is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("thomasJefferson-start");
